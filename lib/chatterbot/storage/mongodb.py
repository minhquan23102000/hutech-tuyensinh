...
class MongoDatabaseAdapter(StorageAdapter):
    ...
    def create_many(self, statements):
        ...
        for statement in statements:
            ...
            if not statement.search_text:
                statement_data['search_text'] = self.tagger.get_bigram_pair_string(
                    statement.text)

            if not statement.search_in_response_to and statement.in_response_to:
                statement_data['search_in_response_to'] = self.tagger.get_bigram_pair_string(
    ...
    def update(self, statement):
        ...
        if data.get('in_response_to'):
            data['search_in_response_to'] = self.tagger.get_bigram_pair_string(
                data['in_response_to'])
